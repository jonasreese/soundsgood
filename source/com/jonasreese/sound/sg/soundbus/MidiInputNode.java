...
/**
 * <p>
 * This class implements the <code>SbNode</code> interface for a MIDI input node.
 * </p>
 * @author jonas.reese
 */
public interface MidiInputNode extends SbNode {
    /**
    ...
    /**
     * Associates a MIDI device with this <code>MidiInputNode</code>.
     * @param midiDevice The MIDI device to be set for this <code>MidiInputNode</code>,
