...
/**
 * <p>
 * This class implements the <code>SbNode</code> interface for an audio input node.
 * </p>
 * @author jonas.reese
 */
public interface AudioInputNode extends SbNode {
    /**
    ...
    /**
     * Associates an audio device with this <code>AudioInputNode</code>.
     * @param audioDevice The audio device to be set for this <code>AudioInputNode</code>,
