...
/**
 * <p>
 * This undoable edit is used to connect two <code>SbNode</code>s.
 * </p>
 * <p>
 ...
 * @author jonas.reese
 */
public class ConnectSbNodesEdit extends SgUndoableEdit {
    ...
    /**
     * Constructs a new <code>ConnectSbNodesEdit</code>.
     * @param soundbusDescriptor The <code>SoundbusDescriptor</code> containing
     * the <code>Soundbus</code> this edit is performed on.
     * @param input The input to connect to the output.
     * @param output The output to connect to the input.
     */
    public ConnectSbNodesEdit(
