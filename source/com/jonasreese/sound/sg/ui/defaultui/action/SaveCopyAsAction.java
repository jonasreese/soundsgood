 ...
 * @author jreese
 */
public class SaveCopyAsAction extends SgAction
    ...
    /**
     * Constructs a new <code>SaveCopyAsAction</code>.
     ...
     */
    public SaveCopyAsAction( Component parent, String name, Icon icon, Session session )
    {
        super( name, icon );
        this.parent = parent;
